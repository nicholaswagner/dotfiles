# lightcolors.py — Radix UI light color scales
# Source: https://www.radix-ui.com/colors
# Alpha variants omitted: alpha hex colors are not supported in terminals.

GREY_SCALES = ["GRAY", "MAUVE", "SLATE", "SAGE", "OLIVE", "SAND"]
...
# Scales where step 9/10 are designed for dark (not white) foreground text
DARK_FG_SCALES = ["SKY", "MINT", "LIME", "YELLOW", "AMBER"]

# Natural grey pairings per theme-notes.md
NATURAL_PAIRINGS: dict[str, str] = {
    ...
    "BROWN": "SAND", "ORANGE": "SAND", "AMBER": "SAND", "YELLOW": "SAND",
    "GOLD": "GRAY", "BRONZE": "GRAY",
}

# Semantic color pools per theme-notes.md
SEMANTIC_POOLS: dict[str, list[str]] = {
    "ERROR":   ["RED", "TOMATO", "CRIMSON", "RUBY"],
    "WARNING": ["YELLOW", "AMBER", "ORANGE"],
    "SUCCESS": ["GREEN", "JADE", "TEAL", "MINT", "GRASS"],
    "INFO":    ["BLUE", "INDIGO", "IRIS", "SKY", "CYAN"],
}
